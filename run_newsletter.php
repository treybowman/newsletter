...
define('TEST_MODE', true); // Set to false when going live
...
$topFeedData = fetchFeed('https://YourSite.com/atom/discussions?sort=top');
$newFeedData = fetchFeed('https://YourSite.com/atom/discussions?sort=newest');
...
<table cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px; margin: auto; font-family: Arial, sans-serif; color: #333;">
    <tr>
        <td align="center" style="padding: 20px;">
            <img src="https://YourSite.com/assets/logo-6m4unrdr.png" alt="YourSite Logo" width="200" style="margin-bottom: 20px;">
            <h2 style="color: #007bff; margin: 0;">📫 YourSite Weekly Digest</h2>
            <p style="font-size: 16px;">Here’s a roundup of the hottest and newest discussions from YourSite this week.</p>
        </td>
    </tr>
    ...
    <tr>
        <td align="center" style="padding: 20px; font-size: 14px; color: #777;">
            ...
            <p style="font-size:12px; color:#aaa;">No longer want to receive this? <a href="https://YourSite.com/newsletter/unsubscribe.php?email={{email}}">Unsubscribe here</a>.</p>
